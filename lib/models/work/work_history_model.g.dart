...
AppointmentWorkModel _$WorkHistoryModelFromJson(Map<String, dynamic> json) =>
    AppointmentWorkModel(
      workId: (json['workId'] as num).toInt(),
      toothResponse: json['toothResponse'] == null
          ? null
          : ToothResponse.fromJson(
              json['toothResponse'] as Map<String, dynamic>,
            ),
...
Map<String, dynamic> _$WorkHistoryModelToJson(AppointmentWorkModel instance) =>
    <String, dynamic>{
...
ToothResponse _$ToothResponseFromJson(Map<String, dynamic> json) =>
    ToothResponse(
      ...
      main: Jow.fromJson(json['main'] as Map<String, dynamic>),
      jow: Jow.fromJson(json['jow'] as Map<String, dynamic>),
      innerToothResponse: InnerToothResponse.fromJson(
...
InnerToothResponse _$InnerToothResponseFromJson(Map<String, dynamic> json) =>
    InnerToothResponse(
      right: Jow.fromJson(json['right'] as Map<String, dynamic>),
      left: Jow.fromJson(json['left'] as Map<String, dynamic>),
      top: Jow.fromJson(json['top'] as Map<String, dynamic>),
      bottom: Jow.fromJson(json['bottom'] as Map<String, dynamic>),
      centerRight: Jow.fromJson(json['centerRight'] as Map<String, dynamic>),
      centerLeft: Jow.fromJson(json['centerLeft'] as Map<String, dynamic>),
    );
